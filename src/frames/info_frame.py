...
NAVIGATION_FRAME_TITLE = "Info"


def create_info_frame():
    info_frame = tk.Frame(borderwidth=2, relief="solid", bg="#0109D4")

    # Create a title for the info_frame
    info_frame_title = tk.Label(info_frame, text=NAVIGATION_FRAME_TITLE, bg="#0109D4")
    info_frame_title.grid(row=0, column=0, columnspan=5, sticky="ew")
